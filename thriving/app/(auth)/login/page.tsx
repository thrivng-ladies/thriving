        ...
        <div className="relative flex h-screen w-full flex-row-reverse overflow-hidden group/design-root bg-background-light dark:bg-background-dark font-display">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative bg-gray-100 dark:bg-gray-800 h-full">
                ...
                <div className="absolute bottom-0 left-0 p-16 text-white z-10 max-w-2xl">
                    ...
                    <h2 className="text-5xl font-bold leading-tight mb-4 tracking-tight drop-shadow-md">Welcome back, changemaker.</h2>
                    <p className="text-xl opacity-90 font-light leading-relaxed drop-shadow-sm">Continue your journey with Thriving Lives Foundation.</p>
                </div>
            </div>

            {/* Left Side: Login Form */}
            <div className="flex flex-1 flex-col h-full bg-white dark:bg-background-dark overflow-y-hidden">
                {/* Mobile Header / Logo */}
                ...
                <div className="flex flex-col justify-center flex-1 w-full max-w-[580px] mx-auto px-6 py-8 lg:px-12">
                    ...
                    <div className="mb-8">
                        <div className="flex flex-col gap-2">
                            <p className="text-[#111418] dark:text-white text-3xl font-black leading-tight tracking-[-0.02em]">Log in to your Account</p>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                        ...
                        <div className="flex w-full flex-wrap items-end animate-in fade-in slide-in-from-right-4 duration-300 delay-75">
                            <label className="flex flex-col min-w-40 flex-1 group">
                                <div className="flex justify-between items-center pb-2">
                                    <p className="text-[#111418] dark:text-white text-sm font-medium leading-normal group-focus-within:text-primary transition-colors">Password</p>
                                    <Link href="/forgot-password" className="text-xs font-medium text-primary hover:text-blue-600 transition-colors">Forgot Password?</Link>
                                </div>
                        ...
                        <div className="pt-2 animate-in fade-in slide-in-from-right-4 duration-300 delay-100">
                            <button
                                type="submit"
                        ...
                        <div className="relative flex items-center gap-3 py-2 animate-in fade-in slide-in-from-right-4 duration-300 delay-150">
                            <div className="h-px flex-1 bg-gray-200 dark:bg-gray-700"></div>
                            <span className="text-[#64748b] dark:text-gray-500 text-xs font-medium uppercase tracking-wider">Or continue with</span>
                            <div className="h-px flex-1 bg-gray-200 dark:bg-gray-700"></div>
                        </div>

                        {/* Social Logins - Moved to Bottom */}
                        <div className="grid grid-cols-2 gap-4 animate-in fade-in slide-in-from-right-4 duration-300 delay-200">
                        ...
                        <div className="flex justify-center items-center gap-2 py-2">
                            <p className="text-[#617589] dark:text-gray-400 text-sm font-normal">Don't have an account?</p>
                            <Link href="/register" className="text-primary text-sm font-medium hover:text-blue-600 transition-colors">
                                create an account
                            </Link>
                        </div>
                    </form>
                    ...
                    <p className="mt-6 text-center text-xs text-[#617589]/60 dark:text-gray-500">
                        By logging in, you agree to our <Link href="/terms" className="underline hover:text-primary">Terms of Service</Link> and <Link href="/privacy" className="underline hover:text-primary">Privacy Policy</Link>.
                    </p>
                </div>
            </div>
        </div>
